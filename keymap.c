...
#define ALT_LCBR LALT_T(KC_LCBR)
#define OS_LBRC LGUI_T(KC_LBRC)
#define OS_RBRC RGUI_T(KC_RBRC)
#define ALT_RCBR RALT_T(KC_RCBR)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [UPPER] = LAYOUT_ergodox_pretty(
    ...
    _______, ALT_LCBR,OS_LBRC, KC_LPRN, KC_DQUO, KC_PIPE,                            KC_BSLS, KC_QUOT, KC_RPRN, OS_RBRC,ALT_RCBR, _______,
...
bool rgb_matrix_indicators_user(void) {
  ...
  case LOWER:
    ...
    break;
  case UPPER:
    set_layer_color(UPPER);
    break;
  case NAVI:
    set_layer_color(NAVI);
    break;
  case NUMPAD:
